...
public:
	...
	BOOL get_CSVKeepLeadingZerosAsText()
	{
		BOOL result;
		InvokeHelper(0xcea, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CSVKeepLeadingZerosAsText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcea, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_CSVKeepLargeNumbersAsText()
	{
		BOOL result;
		InvokeHelper(0xceb, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CSVKeepLargeNumbersAsText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xceb, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_CSVKeepDigitsWithEAsText()
	{
		BOOL result;
		InvokeHelper(0xcec, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CSVKeepDigitsWithEAsText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcec, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_CSVDisplayNumberConversionWarning()
	{
		BOOL result;
		InvokeHelper(0xced, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CSVDisplayNumberConversionWarning(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xced, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_CSVKeepColumnAsTextIfMultipleEntriesAreText()
	{
		BOOL result;
		InvokeHelper(0xcee, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CSVKeepColumnAsTextIfMultipleEntriesAreText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcee, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
